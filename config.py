...
DB_URI = os.environ.get("DB_URI", "mongodb+srv://:#@@cluster0.r34v8zi.mongodb.net/?appName=Cluster0") # Warning - Give Db uri in deploy server environment variable, don't give in repo.
