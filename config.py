...
API_ID = int(os.environ.get("API_ID", "31329774"))

# Your API Hash from my.telegram.org
API_HASH = os.environ.get("API_HASH", "6a69b6df9a74b5902b0b031bacb353b7")

# Your Owner / Admin Id For Broadcast 
ADMINS = int(os.environ.get("ADMINS", "7141848479"))
...
DB_URI = os.environ.get("DB_URI", "mongodb+srv://Swaroopji:#Swar135@@cluster0.r34v8zi.mongodb.net/?appName=Cluster0") # Warning - Give Db uri in deploy server environment variable, don't give in repo.
DB_NAME = os.environ.get("DB_NAME", "MyContentSaverrBot")
